...
> Локальный класс без имени, объявляемый прямо при создании экземпляра - обычно для реализации интерфейса или расширения
> класса «на лету».
...
- ### Ограниченная область видимости:
    - Анонимные классы обычно создаются в контексте конкретного использования и могут использоваться только в этом
      месте.
...
Решение: используйте AtomicInteger, массив [1], или делать именованный класс.
