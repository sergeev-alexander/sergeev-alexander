...
- `Test Plan` (План тестирования) - Детальный план, охватывающий цели, объем, ресурсы, расписание, риски и критерии завершения.
...
- `Defect/Bug Report` (Баг-репорт) - Детальное описание обнаруженного дефекта, включая шаги воспроизведения, серьезность, приоритет и окружение.
