...
> 
> Это стандартный способ обозначения изменений в программном обеспечении, для предоставления информации о характере изменений и их совместимости с предыдущими версиями.
