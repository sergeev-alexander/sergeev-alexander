...
Cassandra — **AP-система** (Availability + Partition Tolerance) с возможностью настройки согласованности под задачу.
...
│   "Запишу-ка я hint для узла A. Когда A оживёт — получит данные"        │
│                                                                         │
│   ┌──────────────────────────────────────┐                              │
│   │ Узел D (координатор)                 │                              │
