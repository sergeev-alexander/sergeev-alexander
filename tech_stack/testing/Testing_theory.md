...
- Нагрузочное тестирование — это только «ломание» системы. (На самом деле его основная цель — верификация работоспособности в штатных условиях.)
- Его можно проводить только в конце разработки. (Идеально начинать на этапе проектирования через анализ и моделирование.)
- Достаточно просто знать инструмент. (Успех зависит от глубокого понимания архитектуры, бизнес-логики и методологии тестирования.)
