...
> Классификация по цели и объекту проверки. Один и тот же тест может относиться к разным типам в зависимости от аспекта, который он проверяет.
...
- [`Functional Testing Types` (Типы функционального тестирования)](https://github.com/sergeev-alexander/sergeev-alexander/blob/main/tech_stack/testing/Functional_testing_types.md "Functional_testing_types.md")
  ...
  - *Примеры:* Smoke Testing, Sanity Testing, End-to-End (E2E), User Acceptance Testing (UAT), Interoperability Testing.
...
### 3. Change-related Testing (Тестирование изменений)
...
- [`Change-related Testing Types` (Типы тестирования, основанные на изменениях)](https://github.com/sergeev-alexander/sergeev-alexander/blob/main/tech_stack/testing/Change-Related_testing_types.md "Change-Related_testing_types.md")
  ...
  - *Примеры:* Regression Testing, Re-testing / Confirmation Testing, Migration Testing, A/B Testing (при сравнении версий).
...
> - `Automated Functional Tests` часто реализуются как `Integration` или `E2E` тесты в Spring Boot.